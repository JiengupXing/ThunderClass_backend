...
__all__ = [ 'ProjectTemplate', '_AddIns', 'vbext_rk_Project',
           'vbext_pt_HostProject', 'vbext_CodePaneview',
           'vbext_vm_Design', 'vbext_wt_Locals', 'Reference',
           'vbext_ProjectType', '_VBProjects_Old', 'vbext_pk_Set',
           '_References', 'vbext_ct_ClassModule', '_VBComponents_Old',
           'vbext_pk_Proc', '_Component', '_CodeModule',
           'vbextFileTypeBinary', 'CommandBarEvents', 'Component',
           '_VBProject', 'vbext_pt_StandAlone', 'LinkedWindows',
           'vbext_wt_Find', 'CodePane', 'vbextFileTypeFrx',
           'Properties', '_CodePanes', 'vbext_RefKind',
           'vbext_ProjectProtection', '_CommandBarControlEvents',
           '_dispVBProjectsEvents', 'vbext_pk_Get', 'CodePanes',
           'vbext_pp_none', 'vbext_wt_ProjectWindow', 'CodeModule',
           '_dispCommandBarControlEvents', 'ReferencesEvents',
           'vbext_wt_Watch', '_VBProject_Old', 'Windows',
           '_Windows_old', 'vbext_cv_ProcedureView',
           'vbextFileTypeRes', 'VBComponent', 'vbext_ct_StdModule',
           'vbext_wt_FindReplace', '_dispReferencesEvents',
           'vbext_ws_Maximize', 'vbext_pk_Let', 'vbext_wt_CodeWindow',
           'VBComponents', 'vbext_wt_PropertyWindow', '_VBProjects',
           'vbextFileTypeModule', 'vbext_wt_MainWindow',
           'vbextFileTypeUserControl', '_Windows', 'vbextFileTypes',
           'vbext_wt_LinkedWindowFrame', 'vbext_ws_Minimize',
           '_VBComponentsEvents', '_VBProjectsEvents',
           '_VBComponent_Old', 'vbextFileTypeForm', 'Events',
           '_ReferencesEvents', 'vbextFileTypeDocObject',
           'vbext_VBAMode', 'vbextFileTypeGroupProject',
           'vbext_WindowState', 'SelectedComponents',
           '_LinkedWindows', '_CodePane', 'Window',
           'vbext_wt_Toolbox', 'Components', 'VBE', '_Properties',
           'vbext_ws_Normal', 'Addins', 'vbext_vm_Break',
           '_dispReferences_Events', 'vbext_ct_MSForm',
           'vbext_wt_Designer', '_Components',
           'vbext_cv_FullModuleView', 'vbextFileTypePropertyPage',
           '_VBComponents', '_VBComponent', 'vbext_ProcKind',
           'vbextFileTypeClass', 'vbext_pp_locked',
           '_ProjectTemplate', 'VBProject', 'vbext_ComponentType',
           'vbext_rk_TypeLib', 'vbextFileTypeExe',
           'vbext_wt_ToolWindow', 'vbext_ct_ActiveXDesigner', 'AddIn',
           'vbext_vm_Run', 'VBProjects', '_dispVBComponentsEvents',
           'vbextFileTypeDesigners', 'vbext_WindowType',
           'vbext_wt_Browser', 'Property', 'Application',
           'vbext_ct_Document', 'vbext_wt_Immediate', 'References',
